...
<p>La rubrique <em>Ressources clés</em> définit tous les moyens nécessaires pour produire une offre répondant aux attentes de tes clients : les moyens matériels (mobilier, véhicules, local, etc.), immatériels (brevet, compétence, droit d’auteur, BDD, etc.), humains et financier.</p>
<ul>
...
<h3 id="rubrique-bmc-7--">1.2.7 Rubrique BMC (7) : *</h3>
