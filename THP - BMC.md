...
<h3 id="rubrique-bmc-3--canaux-de-distribution">1.2.3 Rubrique BMC (3) : <em>Canaux de distribution</em></h3>
...
<h3 id="rubrique-bmc-4-relations-clients">1.2.4 Rubrique BMC (4): <em>Relations clients</em></h3>
