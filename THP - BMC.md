...
<p><em>Aparté :<br>
On peut  penser que l’idée de base est un peu foireuse (quoique on trouve bien des cafés à chat sur Paris).<br>
Mais pour l’exemple de l’article on va tout même partir sur l’hypothèse que tu obtiens des retours très positifs sur ton projet après l’enquête mené dans le quartier (en réalité le marché des cafés à Paris et des studios yogas est ultra concurrentiel). Tu as également mapper tous les concurrents et tu as des idées de services qui feront la diffs !</em></p>
<p>Il est temps de construire le Business Model Canvas !</p>
