...
<p>L’étape suivante et de faire une enquête terrain, tu vas arpenter le <em>tieks</em>  afin de mieux connaître ta clientèle  et de la segmenter (Quels budget consacrent-ils à leur bien-être ? Sont-ils prêt à fréquenter un café avec un concept innovant ?, etc) et ainsi préciser son offre (A quel prix ? Quel niveau de service ? Différentes offres ?).</p>
...
<h4 id="comment-analyser-mes-concurrents-"><em>Comment analyser mes concurrents ?</em></h4>
...
<div class="mermaid"><svg xmlns="http://www.w3.org/2000/svg" id="mermaid-svg-G1vBbb1FRMomdMfS" width="100%" style="max-width: 546.953125px;" viewBox="0 0 546.953125 62"><g transform="translate(-12, -12)"><g class="output"><g class="clusters"></g><g class="edgePaths"></g><g class="edgeLabels"></g><g class="nodes"><g class="node" id="id1" transform="translate(285.4765625,43)" style="opacity: 1;"><rect rx="0" ry="0" x="-265.4765625" y="-23" width="530.953125" height="46"></rect><g class="label" transform="translate(0,0)"><g transform="translate(-255.4765625,-13)"><foreignObject width="510.953125" height="26"><div xmlns="http://www.w3.org/1999/xhtml" style="display: inline-block; white-space: nowrap;">Besoin : Prendre un café/ méditer dans le quartier de la gare Saint-Lazare</div></foreignObject></g></g></g></g></g></g></svg></div>
<h2 id="la-cible-clientèle---rubrique-bmc--segments-de-clientèle">1.1 La cible clientèle - Rubrique BMC : <em>Segments de clientèle</em></h2>
