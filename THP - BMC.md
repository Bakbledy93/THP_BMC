...
<p>Enfin on va pouvoir s’attaquer au BMC, pour rappel il est représenté en tableau et est composé des 9 rubriques suivantes (voir <em>§1.1 BMC - Business Model Canvas</em>) :</p>
<p><img src="THP_BMC.png" alt="Canvas"></p>
<h2 id="la-cible-clientèle---rubrique-bmc--segments-de-clientèle">1.2 La cible clientèle - Rubrique BMC : <em>Segments de clientèle</em></h2>
